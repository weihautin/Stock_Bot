...
title = str("OTS每月營收_400") #Email郵件的標題 ex:2015-0411-選股機器人

realtime_txt = open("earn_money_OTS_400.txt", 'w') #開啟檔案,w沒有該檔案就新增
...
if __name__ == "__main__":
        ...
        with open('OTS.csv') as csvfile:
            csvfile = csvfile.readlines()[304:404] 
...
os.system('sendEmail -o \
 ...
 -xp %s \
 -u %s \
 -o message-file=/home/tim/earn_money_OTS_400.txt \
 '%(ID, PW, title))
