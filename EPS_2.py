...
realtime_txt.write(year+"年第二季EPS"+"\n")
...
with open('TWSE.csv') as csvfile:
    ...
    for row in readCSV: #就readCSV裡的所有資料(以列為單位)
        ...
        'encodeURIComponent=1&step=1&firstin=1&off=1&keyword4=&code1=&TYPEK2=&checkbtn=&queryName=co_id&TYPEK=all&isnew=false&co_id='+row[0]+'&year='+year+'&season=02'
