...
realtime_txt = open("earn_money_800.txt", 'w') #開啟檔案,w沒有該檔案就新增
...
if __name__ == "__main__":
        ...
        title = str("TWSE_"+month+"月營收_800") #Email郵件的標題 ex:2015-0411-選股機器人
        ...
        with open('TWSE_utf8.csv') as csvfile:
            csvfile = csvfile.readlines()[702:802]
...
os.system('sendEmail -o \
 ...
 -xp %s \
 -u %s \
 -o message-file=/home/tim/earn_money_800.txt \
 '%(ID, PW, title))


os.remove('earn_money_800.txt')
